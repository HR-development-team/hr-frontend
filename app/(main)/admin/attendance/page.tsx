    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Pantau kehadiran dan waktu kerja karyawan -{" "}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {attendanceData.map((employee) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div
                      className={`text-sm font-medium ${employee.checkIn === "-" ? "text-gray-400" : "text-gray-900"}`}
                    >
                      {employee.checkIn}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div
                      className={`text-sm font-medium ${employee.checkOut === "-" ? "text-gray-400" : "text-gray-900"}`}
                    >
                      {employee.checkOut}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {employee.location !== "-" && (
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getLocationColor(employee.location)}`}
                      >
                        {employee.location}
                      </span>
                    )}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(employee.status)}`}
                    >
                      {employee.status}
                    </span>
                  </td>
        ...
        <div className="px-6 py-4 border-t bg-gray-50">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-700">
              Menampilkan <span className="font-medium">8</span> dari{" "}
              <span className="font-medium">156</span> karyawan
            </div>
            <div className="flex space-x-2">
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">
            Keterlambatan Terbanyak
          </h3>
          <div className="space-y-2">
            {attendanceData
              .filter((e) => e.status === "Terlambat")
              .map((employee) => (
                <div
                  key={employee.id}
