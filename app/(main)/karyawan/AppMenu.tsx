      ...
      {model.map((item, i) => {
        if (item.items) {
          ...
          return (
            <li
              key={i}
              className={classNames({ "active-menuitem": isParentActive })}
            >
              ...
              <ul
                className={classNames("layout-submenu", {
                  "layout-submenu-active": isParentActive,
                })}
              >
                {item.items.map((subItem, j) => {
                  ...
                  return (
                    <li
                      key={j}
                      className={classNames({ "active-menuitem": isSubActive })}
                    >
