...
const mockAllRequests: AllRequest[] = [
  { id: 'C-003', jenis: 'Cuti Tahunan', tanggal: '2025-11-01', detail: '01 Nov - 02 Nov', status: 'Pending' },
  { id: 'L-002', jenis: 'Lembur', tanggal: '2025-10-29', detail: '17:00 - 18:00', status: 'Pending' },
  { id: 'C-001', jenis: 'Cuti Tahunan', tanggal: '2025-10-25', detail: '25 Okt - 25 Okt', status: 'Approved' },
  { id: 'L-001', jenis: 'Lembur', tanggal: '2025-10-25', detail: '17:00 - 19:00', status: 'Approved' },
  { id: 'C-002', jenis: 'Sakit', tanggal: '2025-10-15', detail: '15 Okt - 16 Okt', status: 'Rejected' },
];
...
export default function Page() { // <-- INI BAGIAN PENTING
      ...
      <div className="col-12">
        <Card className="shadow-1" title="Status Semua Pengajuan">
          ...
          >
            ...
            <Column header="Status" body={statusBodyTemplate} sortable field="status" />
          </DataTable>
        </Card>
      </div>
    </div>
