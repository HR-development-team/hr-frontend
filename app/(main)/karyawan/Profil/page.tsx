                            ...
                            <div className="flex flex-column gap-4">
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-envelope mr-2 text-lg text-primary-500" /> Email
                                    </span>
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-id-card mr-2 text-lg text-primary-500" /> Posisi / Jabatan
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-sitemap mr-2 text-lg text-primary-500" /> Divisi
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-building mr-2 text-lg text-primary-500" /> Departemen
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-check-circle mr-2 text-lg text-primary-500" /> Status Kepegawaian
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-calendar-plus mr-2 text-lg text-primary-500" /> Tanggal Bergabung
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                    ...
                    <Card className="border-none shadow-none">
                        <div className="p-3">
                            <div className="flex flex-column gap-4">
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-id-card mr-2 text-lg text-primary-500" /> No. KTP
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                        {profile.ktp_number || "-"}
                                    </span>
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-calendar mr-2 text-lg text-primary-500" /> Tempat, Tanggal Lahir
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                        {profile.birth_place || "-"}, {formatLocalDate(profile.birth_date)}
                                    </span>
                                </div>
                                <Divider className="my-1" />
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-users mr-2 text-lg text-primary-500" /> Jenis Kelamin
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-star mr-2 text-lg text-primary-500" /> Agama
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                        {profile.religion || "-"}
                                    </span>
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-heart mr-2 text-lg text-primary-500" /> Status Pernikahan
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-tint mr-2 text-lg text-primary-500" /> Golongan Darah
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                        {profile.blood_type || "-"}
                                    </span>
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-book mr-2 text-lg text-primary-500" /> Pendidikan
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                        {profile.education || "-"}
                                    </span>
                    ...
                    <Card className="border-none shadow-none">
                        <div className="p-3">
                            <div className="flex flex-column gap-4">
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-briefcase mr-2 text-lg text-primary-500" /> BPJS Ketenagakerjaan
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-heart-fill mr-2 text-lg text-primary-500" /> BPJS Kesehatan
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-file mr-2 text-lg text-primary-500" /> NPWP
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
                                        {profile.npwp || "-"}
                                    </span>
                                ...
                                <div className="flex flex-column md:flex-row md:justify-content-between align-items-start md:align-items-center">
                                    <span className="font-semibold text-base flex align-items-center">
                                        <i className="pi pi-credit-card mr-2 text-lg text-primary-500" /> Akun Bank
                                    </span>
                                    <span className="text-color-secondary text-lg mt-1 md:mt-0 md:text-right">
        ...
        <div className="grid p-fluid">
                ...
                <Card className="profile-summary-card shadow-2 h-full flex flex-column">
                    ...
                    <div className="flex flex-column gap-3 p-4">
                        ...
                        <div className="flex align-items-center">
                            ...
                            <span className="text-base lg:text-lg">{profile.contact_phone}</span>
                        </div>
            ...
            <div className="col-12 lg:col-8">
                ...
                <div className="block lg:hidden mb-3">
                    <label htmlFor="tab-dropdown" className="font-semibold block mb-2">Pilih Halaman</label>
                    <Dropdown 
                        id="tab-dropdown"
                        value={activeIndex} 
                        options={tabOptions} 
